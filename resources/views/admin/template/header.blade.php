<head>
    ...
    <link rel="stylesheet" href="{{ asset('theme/dist/css/sweetalert.css') }}">
    <link rel="stylesheet" href="{{ asset('theme/custom/css/custom.css') }}">
    {{-- <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" /> --}}
    <link rel="stylesheet" href={{ asset("theme/plugins/select2/css/select2.min.css") }}>
    <link rel="stylesheet" href={{ asset('theme/plugins/select2-bootstrap4-theme/select2-bootstrap4.css') }}>
